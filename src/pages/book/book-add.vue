    ...
    export default {
        ...
        methods: {
            ...
            submitForm(dataForm) {
                ...
                if (valid) {
                    this.postRequest('/ms-book-manager/api/book/create', this.dataForm).then(resp => {
                        if (resp && !resp.status) {
            ...
            getAuthorOptions(keyword) {
                ...
                if (keyword !== '') {
                    this.loading = true;
                    this.getRequest('/ms-book-manager/api/bookAuthor/getSelectOptions', {keyword:keyword}).then(resp => {
                        this.loading = false;
                        if (resp && !resp.status) {
                            this.authorOptions = resp;
                        }
                    })
                } else {
                    this.authorOptions = [];
