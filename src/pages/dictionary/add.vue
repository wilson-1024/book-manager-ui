    ...
    <div class="defaultForm">
        <el-form :model="dataForm" :rules="rules" ref="dataForm" size="small"
            ...
            <el-form-item label="编码" prop="code">
                <el-input v-model.number="dataForm.code"></el-input>
            </el-form-item>
    ...
    export default {
        ...
        methods: {
            submitForm(dataForm) {
                ...
                if (valid) {
                    this.postRequest('/ms-book-manager/api/dataDictionary/create', this.dataForm).then(resp => {
                        if (resp && !resp.status) {
            ...
            initData(){
                // 类型数据源
                this.getRequest('/ms-book-manager/api/dataDictionary/getTypeOptions', {}).then(resp => {
                    if (resp && !resp.status) {
