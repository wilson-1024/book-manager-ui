        ...
        <div>
            ...
            <div style="width:42%;float:left">
                <el-form :model="loginForm" :rules="rules" ref="loginForm"
                    ...
                    <h3 class="loginTitle">欢迎使用图书平台</h3>
                    ...
                    <el-form-item style="text-align:right">
                        <el-button type="primary" @click="submitForm('loginForm')" class="submit_btn" size="medium">登录
                        </el-button>
                    </el-form-item>
                </el-form>
            </div>
                    ...
                    if (valid) {
                        ...
                        this.postRequest('/api/auth/login', this.loginForm).then(resp => {
                            ...
                            if (resp && !resp.status) {
                                ...
                                this.db.save("header", resp.authorizationTokenHeader);
                                this.db.save("token", resp.authorizationTokenValue);
                                this.getUserInfo()
