<template>
    <div>
        ...
        <el-table :data="tableData" border style="width: 100%; " size="small">
            ...
            <el-table-column prop="telephone" label="联系电话" width="400" align="center">
            </el-table-column>
    ...
    methods:{
        ...
        handleDelete(userId) {
            this.$confirm('确定要删除吗?', '提示', {
                ...
                this.deleteRequest('/ms-book-user-manager/api//user/delUser',{id:userId}).then(resp => {
                    if (resp == "") {
                        this.getListData();
                    }
                })
        ...
        getListData(){
            // 用户列表
            this.getRequest('/ms-book-user-manager/api/user/listUser',
                {pageNum:this.currentPage,pageSize:this.limit,keyword:this.formInline.keyword}
                ).then(resp => {
                if (resp && !resp.status) {
